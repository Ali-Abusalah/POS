    ...
    <div class="app-shell">
        ...
        <aside class="sidebar-panel" id="sidebarPanel">
            ...
            <nav class="sidebar-nav">
                <a href="{{ route('dashboard') }}" class="sidebar-link {{ request()->is('dashboard') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    Dashboard
                </a>
                <a href="{{ route('pos.index') }}" class="sidebar-link {{ request()->is('/') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
                    POS Sales
                </a>
                <a href="{{ route('sales.index') }}" class="sidebar-link {{ request()->is('sales') && !request()->is('sales/*') ? 'active' : '' }}" onclick="toggleSidebar()">
                ...
                <a href="{{ route('quotes.index') }}" class="sidebar-link {{ request()->is('sales/quotes') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                    Quotes
                </a>
                <a href="{{ route('subscriptions.index') }}" class="sidebar-link {{ request()->is('sales/subscriptions') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>
                    Subscriptions
                </a>
                <a href="{{ route('credit-notes.index') }}" class="sidebar-link {{ request()->is('sales/credit-notes') ? 'active' : '' }}" onclick="toggleSidebar()">
                ...
                <a href="{{ route('items.index') }}" class="sidebar-link {{ request()->is('items') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                    Stock
                </a>
                <a href="{{ route('customers.index') }}" class="sidebar-link {{ request()->is('customers') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    CRM
                </a>
                <a href="{{ route('reports.index') }}" class="sidebar-link {{ request()->is('reports') ? 'active' : '' }}" onclick="toggleSidebar()">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                    Data &amp; Reports
                </a>
                <a href="{{ route('settings.index') }}" class="sidebar-link {{ request()->is('settings') ? 'active' : '' }}" onclick="toggleSidebar()">
        ...
        <div class="search-modal-overlay" id="searchModal" onclick="closeSearch(event)">
            <div class="search-modal" onclick="event.stopPropagation()">
                ...
                <div class="search-modal-results" id="searchResults">
                    ...
                    <a href="{{ route('dashboard') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('pos.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
                        <span>POS Sales</span>
                    </a>
                    <a href="{{ route('sales.create') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                        <span>New Invoice</span>
                    </a>
                    <a href="{{ route('sales.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                        <span>Sales</span>
                    </a>
                    <a href="{{ route('quotes.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                        <span>Quotes</span>
                    </a>
                    <a href="{{ route('subscriptions.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>
                        <span>Subscriptions</span>
                    </a>
                    <a href="{{ route('credit-notes.index') }}" class="search-modal-result">
                    ...
                    <a href="{{ route('items.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                        <span>Items (Stock)</span>
                    </a>
                    <a href="{{ route('customers.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                        <span>Customers (CRM)</span>
                    </a>
                    <a href="{{ route('reports.index') }}" class="search-modal-result">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                        <span>Reports</span>
                    </a>
                    <a href="{{ route('settings.index') }}" class="search-modal-result">
        ...
        <nav class="top-navbar">
            <div class="top-nav-left">
                ...
                <a href="{{ route('pos.index') }}" class="pos-badge-btn">
            ...
            <div class="top-nav-right">
                <div class="dropdown-wrap">
                    ...
                    <div class="nav-dropdown-menu" id="settingsDrop">
                        <a href="{{ route('settings.index') }}" class="nav-dropdown-item">General Settings</a>
                        <a href="{{ route('settings.index') }}" class="nav-dropdown-item">Tax Configuration</a>
                        <a href="{{ route('reports.index') }}" class="nav-dropdown-item">Reports</a>
                    </div>
                </div>
                ...
                <div class="dropdown-wrap">
                    ...
                    <div class="nav-dropdown-menu" id="accountDrop" style="right:0;left:auto">
                        <div class="nav-dropdown-header">
                            {{ Auth::user()->name }}<br>
                            <span style="font-size:0.6875rem;color:#888888;font-weight:400">{{ Auth::user()->role ?? 'User' }}</span>
                        </div>
        ...
        <nav class="secondary-navbar">
            <a href="{{ route('dashboard') }}" class="secondary-nav-item {{ request()->is('dashboard') ? 'active' : '' }}">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                Dashboard
            </a>

            <div class="secondary-nav-dropdown-wrap">
                <button class="secondary-nav-item {{ request()->is('sales*') || request()->is('/') ? 'active' : '' }}" onclick="toggleSalesDropdown(event)">
                ...
                <div class="sales-dropdown" id="salesDrop">
                    <div class="sales-dropdown-item-wrap" onmouseenter="showSubmenu('subPos')" onmouseleave="hideSubmenu('subPos')">
                        <a href="{{ route('pos.index') }}" class="sales-dropdown-item {{ request()->is('/') ? 'active' : '' }}">
                        ...
                        <div class="sales-submenu" id="subPos">
                            <a href="{{ route('sales.create') }}" class="sales-submenu-item">New Invoice</a>
                            <a href="{{ route('pos.index') }}" class="sales-submenu-item">New Invoice V2 - Mobile</a>
                            <a href="{{ route('sales.index') }}" class="sales-submenu-item">Manage Invoices</a>
                        </div>
                    </div>
                    <div class="sales-dropdown-item-wrap" onmouseenter="showSubmenu('subSales')" onmouseleave="hideSubmenu('subSales')">
                        <a href="{{ route('sales.index') }}" class="sales-dropdown-item {{ request()->is('sales') && !request()->is('sales/*') ? 'active' : '' }}">
                    ...
                    <div class="sales-dropdown-item-wrap" onmouseenter="showSubmenu('subQuotes')" onmouseleave="hideSubmenu('subQuotes')">
                        <a href="{{ route('quotes.index') }}" class="sales-dropdown-item {{ request()->is('sales/quotes') ? 'active' : '' }}">
                        ...
                        <div class="sales-submenu" id="subQuotes">
                            <a href="{{ route('quotes.index') }}" class="sales-submenu-item">New Quote</a>
                            <a href="{{ route('quotes.index') }}" class="sales-submenu-item">Manage Quotes</a>
                        </div>
                    </div>
                    <div class="sales-dropdown-item-wrap" onmouseenter="showSubmenu('subSubs')" onmouseleave="hideSubmenu('subSubs')">
                        <a href="{{ route('subscriptions.index') }}" class="sales-dropdown-item {{ request()->is('sales/subscriptions') ? 'active' : '' }}">
                        ...
                        <div class="sales-submenu" id="subSubs">
                            <a href="{{ route('subscriptions.index') }}" class="sales-submenu-item">New Subscription</a>
                            <a href="{{ route('subscriptions.index') }}" class="sales-submenu-item">Manage Subscriptions</a>
                        </div>
                    </div>
                    ...
                    <div class="sales-dropdown-item-wrap" onmouseenter="showSubmenu('subCredit')" onmouseleave="hideSubmenu('subCredit')">
                        <a href="{{ route('credit-notes.index') }}" class="sales-dropdown-item {{ request()->is('sales/credit-notes') ? 'active' : '' }}">
                        ...
                        <div class="sales-submenu" id="subCredit">
                            <a href="{{ route('credit-notes.index') }}" class="sales-submenu-item">New Credit Note</a>
                            <a href="{{ route('credit-notes.index') }}" class="sales-submenu-item">Manage Credit Notes</a>
                        </div>
                    </div>
                </div>
            </div>

            <a href="{{ route('items.index') }}" class="secondary-nav-item {{ request()->is('items') ? 'active' : '' }}">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
                Stock
            </a>
            <a href="{{ route('customers.index') }}" class="secondary-nav-item {{ request()->is('customers') ? 'active' : '' }}">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                CRM
            </a>
            <a href="{{ route('reports.index') }}" class="secondary-nav-item {{ request()->is('reports') ? 'active' : '' }}">
            ...
            <a href="{{ route('settings.index') }}" class="secondary-nav-item {{ request()->is('settings') ? 'active' : '' }}">
