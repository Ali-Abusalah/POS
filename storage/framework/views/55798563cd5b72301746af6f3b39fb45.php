...
<div class="dash-wrap">
    ...
    <div class="gradient-cards">
        <div class="gradient-card gc-green">
            ...
            <div class="gc-info">
                ...
                <div class="gc-value"><?php echo e($data['today_invoices']); ?></div>
            </div>
        </div>
        <div class="gradient-card gc-teal">
            ...
            <div class="gc-info">
                ...
                <div class="gc-value"><?php echo e($data['total_invoices']); ?></div>
            </div>
        </div>
        <div class="gradient-card gc-orange">
            ...
            <div class="gc-info">
                ...
                <div class="gc-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['today_sales'], 2)); ?></div>
            </div>
        </div>
        <div class="gradient-card gc-pink">
            ...
            <div class="gc-info">
                ...
                <div class="gc-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['month_sales'], 2)); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="progress-container">
        <div class="progress-item">
            <div class="pi-pct"><?php echo e($incomePct); ?>%</div>
            <div class="pi-label">August Income</div>
            <div class="pi-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['total_revenue'], 2)); ?></div>
            <div class="pi-bar"><div class="pi-bar-fill green" style="width: <?php echo e($incomePct); ?>%;"></div></div>
        </div>
        <div class="progress-item">
            <div class="pi-pct"><?php echo e($expensePct); ?>%</div>
            <div class="pi-label">August Expenses</div>
            <div class="pi-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['total_tax'], 2)); ?></div>
            <div class="pi-bar"><div class="pi-bar-fill red" style="width: <?php echo e($expensePct); ?>%;"></div></div>
        </div>
        <div class="progress-item">
            <div class="pi-pct"><?php echo e($salesPct); ?>%</div>
            <div class="pi-label">August Sales</div>
            <div class="pi-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['month_sales'], 2)); ?></div>
            <div class="pi-bar"><div class="pi-bar-fill blue" style="width: <?php echo e($salesPct); ?>%;"></div></div>
        </div>
        <div class="progress-item">
            <div class="pi-pct"><?php echo e($netPct); ?>%</div>
            <div class="pi-label">August Net Income</div>
            <div class="pi-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($netIncome, 2)); ?></div>
            <div class="pi-bar"><div class="pi-bar-fill amber" style="width: <?php echo e($netPct); ?>%;"></div></div>
        </div>
    </div>
    ...
    <div class="bottom-grid">
        <div class="chart-card">
            ...
            <div class="chart-body">
                <?php $maxVal = collect($data['series'])->max('total') ?: 1; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $data['series']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $h = $maxVal > 0 ? round(($point['total'] / $maxVal) * 260) : 0; ?>
                    <div class="chart-bar-wrap">
                        <div class="chart-bar-val"><?php echo e($data['currency_symbol']); ?><?php echo e(number_format($point['total'], 0)); ?></div>
                        <div class="chart-bar" style="height: <?php echo e(max(2, $h)); ?>px;" title="<?php echo e($point['date']); ?>: <?php echo e($data['currency_symbol']); ?><?php echo e(number_format($point['total'], 2)); ?>"></div>
                        <div class="chart-bar-date"><?php echo e(\Carbon\Carbon::parse($point['date'])->format('d')); ?></div>
                    </div>
        ...
        <div class="buyers-card">
            ...
            <div class="buyers-list">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['recent_invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $color = $avatarColors[$idx % count($avatarColors)]; ?>
                    <div class="buyer-item">
                        <div class="buyer-avatar" style="background: <?php echo e($color); ?>;"><?php echo e(strtoupper(substr($inv->customer_name, 0, 1))); ?></div>
                        <div class="buyer-info">
                            <div class="buyer-name"><?php echo e($inv->customer_name); ?></div>
                        </div>
                        ...
                        <div class="buyer-amount"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($inv->grand_total, 2)); ?></div>
                    </div>
    ...
    <div class="invoices-section">
        <div class="invoices-stats">
            <div class="inv-stat">
                <div class="is-value"><?php echo e($data['total_invoices']); ?></div>
                <div class="is-label">TOTAL INVOICES (PAID)</div>
            </div>
            <div class="inv-stat">
                <div class="is-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['total_revenue'], 2)); ?></div>
                <div class="is-label">TOTAL REVENUE</div>
            </div>
            <div class="inv-stat">
                <div class="is-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['total_tax'], 2)); ?></div>
                <div class="is-label">TOTAL TAX COLLECTED</div>
            </div>
            <div class="inv-stat">
                <div class="is-value"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($data['total_discount'], 2)); ?></div>
        ...
        <div class="invoices-table-wrap">
            <div class="inv-table-header">
                ...
                <div class="inv-actions">
                    <a href="<?php echo e(url('/sales/create')); ?>" class="inv-btn inv-btn-green">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Add Sale
                    </a>
                    <a href="<?php echo e(url('/invoices')); ?>" class="inv-btn inv-btn-blue">Manage Invoices</a>
                    <a href="<?php echo e(url('/pos')); ?>" class="inv-btn inv-btn-blue">POS</a>
                </div>
            </div>
                ...
                <table class="inv-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['recent_invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><a href="<?php echo e(url('/invoices/' . $inv->id)); ?>" class="inv-link"><?php echo e($inv->invoice_number); ?></a></td>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="inv-badge other"><?php echo e(ucfirst($inv->status)); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td><?php echo e(\Carbon\Carbon::parse($inv->created_at)->format('M d, Y')); ?></td>
                                <td class="text-right text-bold"><?php echo e($data['currency_symbol']); ?> <?php echo e(number_format($inv->grand_total, 2)); ?></td>
                            </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ALI.A.SALAH\Desktop\pos\resources\views/dashboard.blade.php ENDPATH**/ ?>