    ...
    <div class="pos-cart-panel">
        ...
        <div class="pos-summary-section">
            <div class="pos-summary-row">
                <span>Subtotal</span>
                <span id="subtotalDisplay"><?php echo e($settings['primary_symbol']); ?> 0.00</span>
            </div>
            <div class="pos-summary-row">
                <span>Tax (<?php echo e($settings['tax_rate']); ?>%)</span>
                <span id="taxDisplay"><?php echo e($settings['primary_symbol']); ?> 0.00</span>
            </div>
            <div class="pos-summary-total">
                <span>Total</span>
                <span id="totalDisplay"><?php echo e($settings['primary_symbol']); ?> 0.00</span>
            </div>
        </div>
        ...
        <div class="pos-checkout-section">
            ...
            <div style="display:flex;justify-content:space-between;font-size:0.8125rem;color:var(--text-secondary);margin-bottom:0.75rem;">
                <span>Change</span>
                <span id="changeDisplay" style="font-weight:600;color:var(--success);"><?php echo e($settings['primary_symbol']); ?> 0.00</span>
            </div>
...
(function() {
    const symbol = <?php echo json_encode($settings['primary_symbol'], 15, 512) ?>;
    const taxRate = <?php echo e($settings['tax_rate']); ?>;
    let cart = [];
    let allProducts = <?php echo json_encode($products, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ALI.A.SALAH\Desktop\pos\resources\views/pos/index.blade.php ENDPATH**/ ?>