<?php $__env->startSection('page-title', $invoice->invoice_number); ?>
...
<div class="inv-container">
    <div class="inv-header">
        <div class="inv-header-left">
            <a href="<?php echo e(url('/invoices')); ?>" class="inv-btn inv-btn-ghost" style="align-self: flex-start;">←</a>
            ...
            <div class="inv-header-meta">
                ...
                <span><?php echo e(\Carbon\Carbon::parse($invoice->created_at)->format('F d, Y h:i A')); ?></span>
            </div>
        </div>
        <div class="inv-header-right">
            <a href="<?php echo e(url('/invoices/' . $invoice->id . '/print-thermal')); ?>" target="_blank" class="inv-btn">Receipt</a>
            <a href="<?php echo e(url('/invoices/' . $invoice->id . '/print-a4')); ?>" target="_blank" class="inv-btn">A4</a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin' && $invoice->status === 'paid'): ?>
    ...
    <div class="info-grid">
        <div class="info-card">
            ...
            <div class="ic-value"><?php echo e($invoice->customer_name); ?></div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->customer_contact): ?>
                <div class="ic-sub"><?php echo e($invoice->customer_contact); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="info-card">
            <div class="ic-label">Payment Method</div>
            <div class="ic-value"><?php echo e(ucfirst($invoice->payment_method)); ?></div>
        </div>
        <div class="info-card">
            <div class="ic-label">Subtotal</div>
            <div class="ic-value">$<?php echo e(number_format($invoice->subtotal, 2)); ?></div>
        </div>
        <div class="info-card">
            <div class="ic-label">Tax</div>
            <div class="ic-value">$<?php echo e(number_format($invoice->tax_total, 2)); ?></div>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->void_reason): ?>
        <div style="background: #fef2f2; border: 2px solid #fecaca; border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.25rem;">
            ...
            <div style="font-size: 0.875rem; color: #374151;"><?php echo e($invoice->void_reason); ?></div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <table class="items-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td class="text-bold"><?php echo e($item->item_name); ?></td>
                            <td><?php echo e($item->item_code); ?></td>
                            <td class="text-right"><?php echo e($item->quantity); ?></td>
                            <td class="text-right">$<?php echo e(number_format($item->unit_price, 2)); ?></td>
                            <td class="text-right">$<?php echo e(number_format($item->tax_amount, 2)); ?></td>
                            <td class="text-right text-bold">$<?php echo e(number_format($item->line_total, 2)); ?></td>
                        </tr>
        ...
        <div class="items-card-footer">
            <div class="totals-detail">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->amount_paid > 0): ?>
                    <div>Paid: <span>$<?php echo e(number_format($invoice->amount_paid, 2)); ?></span></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->change_amount > 0): ?>
                    <div>Change: <span>$<?php echo e(number_format($invoice->change_amount, 2)); ?></span></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="totals-grand">$<?php echo e(number_format($invoice->grand_total, 2)); ?></div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ALI.A.SALAH\Desktop\pos\resources\views/invoices/show.blade.php ENDPATH**/ ?>