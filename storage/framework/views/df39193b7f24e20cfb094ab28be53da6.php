<?php $__env->startSection('page-title', 'Add Sale'); ?>
...
<div class="sale-wrap">
                ...
                <div>
                    ...
                    <div class="summary-box">
                        <div class="summary-row">
                            ...
                            <span class="value" id="subtotalDisplay"><?php echo e($data['currency_symbol'] ?? '$'); ?>0.00</span>
                        </div>
                        <div class="summary-row">
                            <span class="label">Tax</span>
                            <span class="value" id="taxDisplay"><?php echo e($data['currency_symbol'] ?? '$'); ?>0.00</span>
                        </div>
                        <div class="summary-row">
                        ...
                        <div class="summary-total">
                            <span>Total</span>
                            <span id="totalDisplay"><?php echo e($data['currency_symbol'] ?? '$'); ?>0.00</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="action-bar">
        <a href="<?php echo e(url('/sales')); ?>" class="btn-cancel">Cancel</a>
...
<script>
(function() {
    const currencySymbol = '<?php echo e($data["currency_symbol"] ?? "$"); ?>';
    let lines = [];
    ...
    async function searchCustomers(q) {
        try {
            const res = await apiFetch(`<?php echo e(url('/api/customers')); ?>?q=${encodeURIComponent(q)}&per_page=10`);
    ...
    window.submitInvoice = async function() {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/pos/invoice")); ?>', {
                method: 'POST',
            ...
            if (data.success) {
                ...
                window.location.href = '<?php echo e(url("/invoices")); ?>/' + data.invoice.id;
            } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ALI.A.SALAH\Desktop\pos\resources\views/sales/create.blade.php ENDPATH**/ ?>