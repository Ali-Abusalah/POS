...
(function() {
    ...
    window.saveSubscription = async function() {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>', { method: 'POST', body: JSON.stringify(payload) });
    ...
    window.pauseSub = async function(id) {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>/' + id + '/pause', { method: 'POST' });
            const data = await res.json();
    ...
    window.resumeSub = async function(id) {
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>/' + id + '/resume', { method: 'POST' });
            const data = await res.json();
            if (data.success) loadSubs(); else alert(data.error || 'Error');
        } catch (e) { alert('Error'); }
    };
    ...
    window.cancelSub = async function(id) {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>/' + id + '/cancel', { method: 'POST' });
            const data = await res.json();
            if (data.success) loadSubs(); else alert(data.error || 'Error');
        } catch (e) { alert('Error'); }
    };
    ...
    window.deleteSub = async function(id) {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>/' + id, { method: 'DELETE' });
            const data = await res.json();
    ...
    async function loadSubs() {
        ...
        try {
            const res = await apiFetch('<?php echo e(url("/api/subscriptions")); ?>?' + params);
            const data = await res.json();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ALI.A.SALAH\Desktop\pos\resources\views/subscriptions/index.blade.php ENDPATH**/ ?>